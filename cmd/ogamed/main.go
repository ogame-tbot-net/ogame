...
func start(c *cli.Context) error {
	...
	e.GET("/bot/combat-report", wrapper.GetCombatReportMessagesHandler)
	e.GET("/bot/combat-report/:galaxy/:system/:position", wrapper.GetCombatReportForHandler)
	...
	e.GET("/bot/planets/:planetID/lifeform-bonuses", wrapper.GetLfBonusesHandler)
