...
func TestEnergyTechnologyConstructionTime(t *testing.T) {
	...
	ct := mm.ConstructionTime(5, universeSpeed*researchSpeed, Facilities{ResearchLab: 3}, false, NoClass)
	...
	universeSpeed = 6
	researchSpeed = 1
	ct = mm.ConstructionTime(1, universeSpeed*researchSpeed, Facilities{ResearchLab: 0}, false, NoClass)
	...
	universeSpeed = 1
	researchSpeed = 1
	ct = mm.ConstructionTime(1, universeSpeed*researchSpeed, Facilities{ResearchLab: 10}, false, NoClass)
	assert.Equal(t, 261*time.Second, ct)
	ct = mm.ConstructionTime(1, universeSpeed*researchSpeed, Facilities{ResearchLab: 10}, true, NoClass)
	assert.Equal(t, 196*time.Second, ct)
	ct = mm.ConstructionTime(1, universeSpeed*researchSpeed, Facilities{ResearchLab: 10}, true, Discoverer)
